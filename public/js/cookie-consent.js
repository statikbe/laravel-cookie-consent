...
function initialize() {
  ...
  if (!Object(_util_cookies__WEBPACK_IMPORTED_MODULE_0__["getCookie"])(COOKIE_KEY) && !isIgnoredPage) {
    Object(_util_modals__WEBPACK_IMPORTED_MODULE_2__["showModal"])(modalAlert);
  }

  initSettings();
  Object(_util_dom__WEBPACK_IMPORTED_MODULE_1__["addEventListener"])('click', '.js-lcc-settings-toggle', function () {
    toggleModalSettings();
  });
  Object(_util_dom__WEBPACK_IMPORTED_MODULE_1__["addEventListener"])('click', '.js-lcc-essentials', function () {
    saveSettings(COOKIE_VALUE_NONE);
    Object(_util_modals__WEBPACK_IMPORTED_MODULE_2__["hideModal"])(modalSettings, true);
    Object(_util_modals__WEBPACK_IMPORTED_MODULE_2__["hideModal"])(modalAlert);
  });
  Object(_util_dom__WEBPACK_IMPORTED_MODULE_1__["addEventListener"])('click', '.js-lcc-accept', function () {
    updateCookie('true');
    Object(_util_modals__WEBPACK_IMPORTED_MODULE_2__["hideModal"])(modalSettings, true);
    Object(_util_modals__WEBPACK_IMPORTED_MODULE_2__["hideModal"])(modalAlert);
  });
  Object(_util_dom__WEBPACK_IMPORTED_MODULE_1__["addEventListener"])('click', '.js-lcc-settings-save', function () {
    saveSettings();
    toggleModalSettings();
    Object(_util_modals__WEBPACK_IMPORTED_MODULE_2__["hideModal"])(modalAlert);
  });
...
function toggleModalSettings() {
  if (Object(_util_dom__WEBPACK_IMPORTED_MODULE_1__["isHidden"])(modalSettings)) {
    Object(_util_modals__WEBPACK_IMPORTED_MODULE_2__["showModal"])(modalSettings, !Object(_util_dom__WEBPACK_IMPORTED_MODULE_1__["isHidden"])(modalAlert));
    initSettings();
  ...
  function hideModalSettings() {
    ...
    Object(_util_modals__WEBPACK_IMPORTED_MODULE_2__["hideModal"])(modalSettings, !Object(_util_cookies__WEBPACK_IMPORTED_MODULE_0__["getCookie"])(COOKIE_KEY));

    if (!Object(_util_cookies__WEBPACK_IMPORTED_MODULE_0__["getCookie"])(COOKIE_KEY)) {
      Object(_util_modals__WEBPACK_IMPORTED_MODULE_2__["showModal"])(modalAlert, true);
    }
...
function initSettings() {
  var cookieValue = Object(_util_cookies__WEBPACK_IMPORTED_MODULE_0__["getCookie"])(COOKIE_KEY);
...
function updateCookie(cookieValue) {
  Object(_util_cookies__WEBPACK_IMPORTED_MODULE_0__["setCookie"])(COOKIE_KEY, COOKIE_EXPIRATION_DAYS, cookieValue); //  Fire GTM event if dataLayer is found
...
/*!**********************************!*\
  !*** ./resources/js/util/dom.js ***!
  \**********************************/
/*! exports provided: showElement, hideElement, isHidden, elementMatchesSelector, getSiblings, addEventListener */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "elementMatchesSelector", function() { return elementMatchesSelector; });
...
function showModal(modal) {
  ...
  Object(_dom__WEBPACK_IMPORTED_MODULE_0__["getSiblings"])(modal, ':not(.js-lcc-backdrop)').forEach(function (sibling) {
    sibling.inert = true;
  });
  modal.inert = false;
  ...
  Object(_dom__WEBPACK_IMPORTED_MODULE_0__["showElement"])(modal);
}
function hideModal(modal) {
  var ignoreBackdrop = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  Object(_dom__WEBPACK_IMPORTED_MODULE_0__["getSiblings"])(modal, ':not(.js-lcc-modal)').forEach(function (sibling) {
    sibling.inert = false;
  });
  modal.inert = true;
  Object(_dom__WEBPACK_IMPORTED_MODULE_0__["hideElement"])(modal);
...
function fadeBackdrop() {
  ...
  if (Object(_dom__WEBPACK_IMPORTED_MODULE_0__["isHidden"])(backdropElement)) {
    Object(_dom__WEBPACK_IMPORTED_MODULE_0__["showElement"])(backdropElement);
  ...
  function hideBackdrop() {
    Object(_dom__WEBPACK_IMPORTED_MODULE_0__["hideElement"])(backdropElement);
...
/***/ 0:
/*!***********************************************************************************!*\
  !*** multi ./resources/js/cookie-consent.js ./resources/sass/cookie-consent.scss ***!
  \***********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /Users/stijnelskens/Sites/laravel-cookie-consent/resources/js/cookie-consent.js */"./resources/js/cookie-consent.js");
module.exports = __webpack_require__(/*! /Users/stijnelskens/Sites/laravel-cookie-consent/resources/sass/cookie-consent.scss */"./resources/sass/cookie-consent.scss");
