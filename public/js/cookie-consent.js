...
var SESSION_DOMAIN = modalAlert.dataset.sessionDomain;
var COOKIE_SECURE = !!modalAlert.dataset.cookieSecure;
...
function updateCookie(cookieValue) {
  (0,_util_cookies__WEBPACK_IMPORTED_MODULE_0__.setCookie)(COOKIE_KEY, cookieValue, COOKIE_EXPIRATION_DAYS, SESSION_DOMAIN, COOKIE_SECURE);
  if (onConsentChange) {
...
function elementMatchesSelector(element, selector) {
  ...
  var propertySuffix = 'MatchesSelector';
